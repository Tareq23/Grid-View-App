...
import 'package:grid_view_app/pages/sliver_grid.dart';
        ...
        children: [
          ...
          Expanded(
            ...
            child: Padding(
              ...
              child: _basicTabAcitve == true ? const BasicGridWidget() : _dynamicTabAcitve == true ? const GridStaggered() : _sliverTabAcitve == true ? SliverGridStaggered() : null,
            ),
          )
